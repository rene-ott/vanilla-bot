...
@YamlClassMemberKey("bank_items_counts")
public class BankItemsCountsFieldNameMatcher extends ClassMemberNameBaseMatcher implements MudClientClassFieldNameMatcher {

    public BankItemsCountsFieldNameMatcher() {
