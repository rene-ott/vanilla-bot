...
@YamlClassMemberKey("put_int")
public class PutIntMethodNameMatcher extends ClassMemberNameBaseMatcher implements PacketBuilderBaseClassMethodNameMatcher {

    public PutIntMethodNameMatcher() {
        pattern = Pattern.compile(
            "(?<pre> {3}public final void )(?<fieldName>[a-zA-Z]{1,2})(?<post>\\(int var1\\) \\{\\R" +
            " {6}this\\.[a-zA-Z]{1,2}\\[this\\.[a-zA-Z]{1,2}\\+\\+] = \\(byte\\)\\(var1 >> 24\\);)",
            Pattern.MULTILINE
        );
    }
}
