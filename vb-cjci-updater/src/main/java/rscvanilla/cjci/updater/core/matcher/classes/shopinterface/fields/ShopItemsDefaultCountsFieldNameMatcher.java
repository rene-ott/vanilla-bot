...
@YamlClassMemberKey("shop_items_default_counts")
public class ShopItemsDefaultCountsFieldNameMatcher extends ClassMemberNameBaseMatcher implements ShopInterfaceClassFieldNameMatcher {

    public ShopItemsDefaultCountsFieldNameMatcher() {
