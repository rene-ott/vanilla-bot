...
public class b implements Runnable {
   ...
   protected void h() {
      ...
      if (var1 == null) {
         ...
         for(int var7 = 0; var7 < com.rsc.a.a.K(); ++var7) {
            ...
            this.R[var7].gy = com.rsc.a.a.j(var7).equals("giantcrystal");
         }
   ...
   protected void j() {
      ...
      for(int var1 = 0; var1 < com.rsc.a.a.L(); ++var1) {
         ...
         int var4 = var3.cm.bq * var3.cm.br;
         int[] var5 = var3.bb();
         int[] var6 = new int['耀'];
         ...
         this.L.a(var1, var3.ck / 64 - 1, var26, var24);
      }
