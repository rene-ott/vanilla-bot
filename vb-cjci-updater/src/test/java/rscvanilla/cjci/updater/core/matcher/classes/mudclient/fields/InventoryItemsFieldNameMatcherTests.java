...
public class InventoryItemsFieldNameMatcherTests extends BaseTests {

    private InventoryItemsFieldNameMatcher matcher;

    @BeforeEach
    public void setMatcher() {
        matcher = new InventoryItemsFieldNameMatcher();
    }
