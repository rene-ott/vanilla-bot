...
public class BankItemCountListFieldNameMatcherTests extends BaseTests {

    private BankItemCountListFieldNameMatcher matcher;

    @BeforeEach
    public void setMatcher() {
        matcher = new BankItemCountListFieldNameMatcher();
    }
