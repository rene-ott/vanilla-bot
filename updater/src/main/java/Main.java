...
import hooker.infrastructure.modules.FieldMatcherModule;
import hooker.infrastructure.modules.FilePathModule;
import hooker.infrastructure.modules.MainModule;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        injector.getInstance(MainServiceClass.class).doSomething();
    }
}
