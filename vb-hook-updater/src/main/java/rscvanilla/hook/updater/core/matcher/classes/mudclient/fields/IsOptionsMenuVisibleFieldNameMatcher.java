...
@YamlClassMemberKey("is_options_menu_visible")
public class IsOptionsMenuVisibleFieldNameMatcher extends ClassMemberNameBaseMatcher implements MudClientClassFieldNameMatcher {

    public IsOptionsMenuVisibleFieldNameMatcher() {
