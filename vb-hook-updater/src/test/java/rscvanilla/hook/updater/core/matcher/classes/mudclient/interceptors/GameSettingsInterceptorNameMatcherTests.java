...
public class GameSettingsInterceptorNameMatcherTests extends BaseTests {

    private GameSettingsInterceptorNameMatcher matcher;

    @BeforeEach
    public void setMatcher() {
        matcher = new GameSettingsInterceptorNameMatcher();
    }
