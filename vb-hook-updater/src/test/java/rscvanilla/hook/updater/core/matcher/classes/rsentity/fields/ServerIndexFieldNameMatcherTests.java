...
public class ServerIndexFieldNameMatcherTests extends BaseTests {

    private ServerIndexFieldNameMatcher matcher;

    @BeforeEach
    public void setMatcher() {
        matcher = new ServerIndexFieldNameMatcher();
    }
    ...
    public void testMatchField() {
        ...
        assertThat(result.getMemberName(), equalTo("lT"));
