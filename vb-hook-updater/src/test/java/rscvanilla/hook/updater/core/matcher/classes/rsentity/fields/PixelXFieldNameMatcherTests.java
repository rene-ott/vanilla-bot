...
public class PixelXFieldNameMatcherTests extends BaseTests {

    private PixelXFieldNameMatcher matcher;

    @BeforeEach
    public void setMatcher() {
        matcher = new PixelXFieldNameMatcher();
    }
    ...
    public void testMatchField() {
        ...
        assertThat(result.getMemberName(), equalTo("lW"));
