...
public class LocalPositionYFieldNameMatcherTests extends BaseTests {

    private LocalPositionYFieldNameMatcher matcher;

    @BeforeEach
    public void setMatcher() {
        matcher = new LocalPositionYFieldNameMatcher();
    }
    ...
    public void testMatchField() {
        ...
        assertThat(result.getMemberName(), equalTo("lV"));
