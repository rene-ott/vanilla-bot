...
public class c {
   ...
   public int lm = -2;
   public int ln = 0;
   public final int[] lo = new int[256];
   public final int[] lp = new int[256];
   public final int[] lq = new int[256];
   public final int[] lr = new int[256];
   ...
   public void bR() {
      ...
      int var6;
      int var7;
      if (this.a.t() != 0 && this.a.cE() == com.rsc.b.b.cu) {
         this.a.e(0);
         ...
         for(var4 = 0; var4 < 5; ++var4) {
            for(var5 = 0; var5 < 8; ++var5) {
               var6 = var5 * 49 + 7;
               var7 = var4 * 34 + 28;
               if (var1 > var6 && 49 + var6 > var1 && var2 > var7 && var7 + 34 > var2 && this.lp[var3] != -1) {
                  this.ll = var3;
                  this.lm = this.lp[var3];
               }
         ...
         if (this.ll >= 0) {
            var4 = this.lp[this.ll];
            if (var4 != -1) {
               var5 = this.lo[this.ll];
               if (var5 > 0 && var2 >= 204 && var2 <= 215) {
                  ...
                  if (var1 > 388 && var1 < 400) {
                     this.a.a(new String[]{"Type the number of items to buy and press enter"}, com.rsc.b.b.cz, true);
                  }

                  if (var10 > 0) {
                     this.a.n().aO(236);
                     this.a.n().aL(this.lp[this.ll]);
                     this.a.n().aL(var5);
                     this.a.n().aL(var10);
                     this.a.n().dW();
                  }
               ...
               if (var6 > 0 && var2 >= 229 && var2 <= 240) {
                  ...
                  if (var1 > 388 && var1 < 400) {
                     this.a.a(new String[]{"Type the number of items to sell and press enter"}, com.rsc.b.b.cA, true);
                  }
      ...
      for(var6 = 0; var6 < 5; ++var6) {
         for(var7 = 0; var7 < 8; ++var7) {
            ...
            if (this.lp[var5] != -1) {
               this.M.a(this.M.ad(this.lp[var5]), var8, var9, 48, 32, com.rsc.a.a.l(this.lp[var5]).aB(), 0, 0, 255, false, 0, 1);
               this.M.a((String)("" + this.lo[var5]), 1 + var8, 10 + var9, 65280, 1);
               this.M.a(47 + var8, "" + this.a.aB(this.lp[var5]), 10 + var9, 65535, 1);
            }
      ...
      if (this.ll != -1) {
         var5 = this.lp[this.ll];
         if (var5 != -1) {
            var6 = this.lo[this.ll];
            if (var6 <= 0) {
               this.M.c(204 + var1, 214 + var2, "This item is not currently available to buy", 16776960, 3, -1);
            } else {
               var7 = f.a(com.rsc.a.a.l(var5).az(), this.lq[this.ll], this.lj, true, 1, var6, this.lk);
            ...
            if (var7 <= 0) {
               ...
               var8 = f.a(com.rsc.a.a.l(var5).az(), this.lr[this.ll], this.ln, false, 1, var6, this.lk);
