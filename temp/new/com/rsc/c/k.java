...
public class k {
   ...
   private int[] jz;
   private int[] jA;
   private final int[] jB = new int[]{12, 14, 14, 15, 15, 19, 24, 29};
   ...
   public void b(int var1, String var2) {
      int var3 = (this.iU - 281) / 2;
      var3 += 2;
      int var4 = (this.jp - 148) / 2;
      var4 += 90;
   ...
   private final void a(boolean var1, byte[] var2, int var3, int var4, int var5, int var6) {
      ...
      int var12 = var9 + var10 * this.iU;
      int var13 = this.iU - var7;
      int var14;
      if (var10 < this.jr) {
         var14 = this.jr - var10;
         var11 += var14 * var7;
      ...
      if (var10 + var8 >= this.ju) {
         var8 -= 1 + var10 + var8 - this.ju;
      }
      ...
      if (this.jt <= var7 + var9) {
         var15 = var7 + var9 - this.jt + 1;
         var13 += var15;
         var14 += var15;
         var7 -= var15;
      }
      ...
      if (var7 > 0 && var8 > 0) {
         if (var1) {
            this.a(var2, var4, var7, var12, var8, var14, var13, this.jq, var11);
         } else {
            this.a(var4, this.jq, var12, var13, var8, var7, var11, var2, var14);
         }
      }
   ...
   public final void a(com.rsc.a.b.c var1, int var2, int var3, int var4, int var5, int var6) {
      try {
         ...
         if (var1.ci) {
            ...
            var12 = (var14 << 16) / var5;
            var2 += (var14 + var5 * var1.ck - 1) / var14;
            var3 += (var13 + var1.cj * var4 - 1) / var13;
            var11 = (var13 << 16) / var4;
            if (var4 * var1.cj % var13 != 0) {
               var9 = (var13 - var1.cj * var4 % var13 << 16) / var4;
            }

            if (var1.ck * var5 % var14 != 0) {
               var10 = (var14 - var1.ck * var5 % var14 << 16) / var5;
            }

            var4 = var4 * (var1.cn.br - (var9 >> 16)) / var13;
            var5 = (var1.cn.bs - (var10 >> 16)) * var5 / var14;
         }

         var13 = var2 * this.iU + var3;
         if (this.jr > var2) {
            var14 = this.jr - var2;
            var5 -= var14;
            var2 = 0;
         ...
         if (var2 + var5 >= this.ju) {
            var5 -= 1 + var5 + (var2 - this.ju);
         }

         if (var3 + var4 >= this.jt) {
            var15 = 1 + var3 + (var4 - this.jt);
            var14 += var15;
            var4 -= var15;
         }
         ...
         this.a(var1.bb(), var9, var10, this.jq, var13, var4, var14, var7, var5, var11, var12, var6, var17);
   ...
   public final void a(com.rsc.a.b.c var1, int var2, int var3, int var4) {
      if (var1 != null) {
         ...
         int var6 = var1.cn.bs;
         int var7 = var1.cn.br;
         int var8 = this.iU * var3 + var2;
         int var9 = this.iU - var7;
         int var10 = 0;
         int var11;
         if (var3 < this.jr) {
            var11 = this.jr - var3;
         ...
         if (var6 + var3 >= this.ju) {
            var6 -= 1 + var6 + (var3 - this.ju);
         }
         ...
         if (this.jt <= var2 + var7) {
            var11 = var2 - (-var7 - 1) - this.jt;
            var9 += var11;
            var7 -= var11;
            var10 += var11;
         }
         ...
         if (var7 > 0 && var6 > 0) {
            ...
            this.a(var5, var6, var8, var1.bb(), var4, var12, this.jq, var10, var9, var7);
         }
   ...
   public final void a(int var1, int var2, com.rsc.a.b.c var3, int var4, int var5, int var6) {
      try {
         ...
         if (var3.ci) {
            ...
            if (var3.cj * var6 % var13 != 0) {
               var9 = (var13 - var3.cj * var6 % var13 << 16) / var6;
            }

            var1 += (var6 * var3.cj + var13 - 1) / var13;
            var11 = (var13 << 16) / var6;
            var4 += (var14 + var5 * var3.ck - 1) / var14;
            var12 = (var14 << 16) / var5;
            if (var3.ck * var5 % var14 != 0) {
               var10 = (var14 - var5 * var3.ck % var14 << 16) / var5;
            }

            var5 = var5 * (var3.cn.bs - (var10 >> 16)) / var14;
            var6 = (var3.cn.br - (var9 >> 16)) * var6 / var13;
         }

         var13 = var1 + var4 * this.iU;
         var14 = this.iU - var6;
         int var15;
         if (this.jr > var4) {
            var15 = this.jr - var4;
         ...
         if (this.ju <= var4 + var5) {
            var5 -= var4 + var5 - (this.ju - 1);
         }

         if (this.jt <= var1 + var6) {
            var15 = var1 + var6 + (1 - this.jt);
            var6 -= var15;
            var14 += var15;
         }
         ...
         this.a(var10, var11, var6, var9, var14, var3.bb(), var13, this.jq, var7, false, var12, var5, var2, var16);
      ...
      for(int var7 = var4; var7 < var4 + var5; ++var7) {
         for(int var8 = var3; var3 + var1 > var8; ++var8) {
            ...
            for(int var13 = var7 - var6; var13 <= var6 + var7; ++var13) {
               if (var13 >= 0 && this.iU > var13) {
                  for(int var14 = var8 - var2; var14 <= var8 + var2; ++var14) {
                     if (var14 >= 0 && this.jp > var14) {
                        int var15 = this.jq[this.iU * var14 + var13];
                        var11 += 255 & var15;
                        ++var12;
                        var10 += (var15 & 'ﾁ') >> 8;
            ...
            this.jq[var7 + var8 * this.iU] = var11 / var12 + (var9 / var12 << 16) + (var10 / var12 << 8);
         }
      }
      ...
      try {
         ...
         for(int var12 = 0; var1.length() > var12; ++var12) {
            if (var1.charAt(var12) == '@' && 4 + var12 < var1.length() && var1.charAt(var12 + 4) == '@') {
               ...
               if (var13 < 0 || var13 >= com.rsc.c.a.dr.length) {
                  var13 = ' ';
               }

               var8 += var9[7 + com.rsc.c.a.dr[var13]];
            }
   ...
   public final void a(String var1, int var2, int var3, int var4, int var5, int var6, boolean var7, boolean var8) {
      try {
         int var9 = 0;
         byte[] var10 = com.rsc.c.a.dq[var5];
         int var11 = 0;
         int var12 = 0;
         ...
         for(int var13 = 0; var1.length() > var13; ++var13) {
            if (var1.charAt(var13) == '@' && 4 + var13 < var1.length() && var1.charAt(var13 + 4) == '@') {
               ...
               if (var14 < 0 || var14 >= com.rsc.c.a.dr.length) {
                  var14 = ' ';
               }

               var9 += var10[7 + com.rsc.c.a.dr[var14]];
            }
   ...
   private final void a(int[] var1, int[] var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14, int var15, int var16, int var17) {
      ...
      try {
         ...
         for(int var29 = -var14; var29 < 0; ++var29) {
            ...
            if (this.jt <= var31 + var32) {
               var33 = var31 - this.jt + var32;
               var32 -= var33;
            }
               ...
               for(var33 = var31; var31 + var32 > var33; ++var33) {
                  ...
                  if (var34 != 0) {
                     ...
                     if (var35 == var36 && var37 == var36) {
                        ...
                        var42 = (this.jq[var33 + var15] & 255) * var21;
                        var43 = var21 * (('\uff00' & this.jq[var33 + var15]) >> 8);
                        int var44 = var21 * ((this.jq[var33 + var15] & 16711680) >> 16);
                        ...
                        var41 = (this.jq[var33 + var15] & 255) * var21;
                        var42 = var21 * (('\uff00' & this.jq[var33 + var15]) >> 8);
                        var43 = var21 * ((this.jq[var33 + var15] & 16711680) >> 16);
   ...
   public final com.rsc.a.b.c k(int var1, int var2, int var3, int var4) {
      ...
      for(int var7 = var1; var7 < var1 + var3; ++var7) {
         for(int var8 = var2; var8 < var2 + var4; ++var8) {
            var5[var6++] = this.jq[var7 + var8 * this.iU];
         }
      }

      com.rsc.a.b.c var9 = new com.rsc.a.b.c();
      var9.cn = a(var5, var3, var4);
      var9.cl = var3;
      var9.cm = var4;
      return var9;
   }
   ...
   public final void f(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      int var15 = var1 + this.iU * var2;

      for(int var16 = 0; var4 > var16; var16 += var14) {
         if (this.jr <= var16 + var2 && var2 + var16 < this.ju) {
   ...
   public final void c(boolean var1) {
      ...
      if (var1 == !this.jb) {
         ...
         for(int var4 = -this.jp; var4 < 0; var4 += 2) {
            for(int var5 = -this.iU; var5 < 0; ++var5) {
               this.jq[var3++] = 0;
            }
   ...
   private final int ab(int var1) {
      return var1 != 0 ? com.rsc.c.a.dq[var1][8] - 1 : com.rsc.c.a.dq[var1][8] - 2;
   }
   ...
   public final com.rsc.a.b.c l(int var1, int var2, int var3, int var4) {
      ...
      for(int var7 = var2; var7 < var2 + var4; ++var7) {
         for(int var8 = var1; var8 < var1 + var3; ++var8) {
            var5[var6++] = this.jq[var8 + var7 * this.iU];
         }
      }

      com.rsc.a.b.c var9 = new com.rsc.a.b.c();
      var9.cn = new com.rsc.a.b.a((byte[])null, var5, var3, var4);
      var9.cl = var3;
      var9.cm = var4;
      return var9;
   }
   ...
   public final void g(int var1, int var2, int var3, int var4, int var5, int var6) {
      ...
      if (this.jt < var1 + var3) {
         var3 = this.jt - var1;
      }

      if (this.ju < var4 + var2) {
         var4 = this.ju - var2;
      }
      ...
      int var13 = var1 + this.iU * var2;

      for(int var14 = 0; var14 < var4; var14 += var12) {
         for(int var15 = -var3; var15 < 0; ++var15) {
            int var16 = var7 * (this.jq[var13] & 255);
            int var17 = var7 * ((16711680 & this.jq[var13]) >> 16);
            int var18 = var7 * (('\uff00' & this.jq[var13]) >> 8);
   ...
   public final void g(int var1, int var2, int var3, int var4, int var5) {
      ...
      for(int var13 = var10; var11 >= var13; var13 += var12) {
         ...
         int var18 = var16 + this.iU * var13;

         for(int var19 = var16; var17 >= var19; ++var19) {
            int var20 = (this.jq[var18] & 255) * var6;
            int var21 = var6 * (('\uff00' & this.jq[var18]) >> 8);
            int var22 = var6 * ((this.jq[var18] & 16711680) >> 16);
   ...
   public final void b(int var1, int var2, String var3, int var4, int var5, int var6, String var7) {
      try {
         ...
         if (var6 > 0) {
            ...
            if (var8 != null) {
               this.a(var8, var1, var2 - var8.cn.bs);
               var1 += var8.cn.br + 3;
            }
         }

         this.jn = false;
         byte[] var15 = com.rsc.c.a.dq[var4];
         ...
         for(int var9 = 0; var3.length() > var9; ++var9) {
            if (var3.charAt(var9) == '@' && var9 + 4 < var3.length() && var3.charAt(var9 + 4) == '@') {
               ...
               if (var3.charAt(var9) == '~' && 4 + var9 < var3.length() && var3.charAt(4 + var9) == '~') {
                  ...
                  if (var10 < 0 || var10 >= com.rsc.c.a.dr.length) {
                     var10 = ' ';
                  }

                  int var11 = com.rsc.c.a.dr[var10];
                  if (this.jo && !com.rsc.c.a.dt[var4] && var5 != 0) {
                     this.a(com.rsc.c.a.dt[var4], var15, 1 + var1, 0, var11, var2);
                  }

                  if (this.jo && !com.rsc.c.a.dt[var4] && var5 != 0) {
                     this.a(com.rsc.c.a.dt[var4], var15, var1, 0, var11, var2 + 1);
                  }

                  this.a(com.rsc.c.a.dt[var4], var15, var1, var5, var11, var2);
                  if (this.jn) {
   ...
   public final void m(int var1, int var2, int var3, int var4) {
      if (this.jr <= var2 && var2 < this.ju) {
         if (this.js > var1) {
            var3 -= this.js - var1;
            var1 = this.js;
         }

         if (var1 + var3 > this.jt) {
            var3 = this.jt - var1;
         }

         if (var3 > 0) {
            int var5 = var1 + this.iU * var2;

            for(int var6 = 0; var3 > var6; ++var6) {
               this.jq[var5 + var6] = var4;
            }
         }
      }
   ...
   public final void n(int var1, int var2, int var3, int var4) {
      if (this.js <= var1 && var1 < this.jt) {
         if (var2 < this.jr) {
            var4 -= this.jr - var2;
            var2 = this.jr;
         }

         if (var2 + var4 > this.ju) {
            var4 = this.ju - var2;
         }
         ...
         if (var4 > 0) {
            ...
            for(int var6 = 0; var4 > var6; ++var6) {
               this.jq[var5 + this.iU * var6] = var3;
            }
         }
      }
   ...
   public final void a(com.rsc.a.b.c var1, int var2, int var3, int var4, int var5) {
      ...
      int var10 = var1.cn.br + var8;
      int var11 = var1.cn.bs + var9;
      var5 &= 255;
      int var12 = i.hP[var5] * var4;
      int var13 = i.hQ[var5] * var4;
      ...
      if (this.jA == null || var7 + 1 != this.jA.length) {
         this.jv = new int[var7 + 1];
         this.jw = new int[1 + var7];
         this.jx = new int[var7 + 1];
         this.jy = new int[1 + var7];
         this.jz = new int[1 + var7];
         this.jA = new int[var7 + 1];
      }
      ...
      for(var24 = var22; var24 <= var23; ++var24) {
         this.jA[var24] = 99999999;
         this.jx[var24] = -99999999;
      }

      int var25 = 0;
      int var26 = 0;
      int var27 = 0;
      int var28 = var1.cn.br;
      var10 = var28 - 1;
      int var29 = var1.cn.bs;
      int var30 = var28 - 1;
      byte var31 = 0;
      byte var32 = 0;
      byte var33 = 0;
      ...
      for(var39 = var24; var36 >= var39; ++var39) {
         this.jA[var39] = this.jx[var39] = var37;
         var37 += var25;
         var40 = this.jw;
         this.jy[var39] = 0;
         var40[var39] = 0;
         this.jv[var39] = this.jz[var39] = var38;
         var38 += var27;
      }
      ...
      for(var39 = var24; var36 >= var39; ++var39) {
         if (this.jA[var39] > var37) {
            this.jA[var39] = var37;
            this.jw[var39] = var41;
            this.jv[var39] = 0;
         }

         if (var37 > this.jx[var39]) {
            this.jx[var39] = var37;
            this.jy[var39] = var41;
            this.jz[var39] = 0;
         }
      ...
      for(int var42 = var22; var42 < var23; ++var42) {
         int var43 = this.jA[var42] >> 8;
         int var44 = this.jx[var42] >> 8;
         if (var44 - var43 > 0) {
            int var45 = this.jw[var42] << 9;
            int var46 = ((this.jy[var42] << 9) - var45) / (var44 - var43);
            int var47 = this.jv[var42] << 9;
            int var48 = ((this.jz[var42] << 9) - var47) / (var44 - var43);
            if (var44 > this.jt) {
               var44 = this.jt;
            }

            if (var43 < this.js) {
               var47 += (this.js - var43) * var48;
               var45 += (this.js - var43) * var46;
               var43 = this.js;
            }

            if (!this.jb || (var42 & 1) == 0) {
               if (var1.ci) {
                  this.a(var48, var43 - var44, var45, var40, this.jq, var47, var43 + var39, var28, var46);
               } else {
                  this.a(var43 - var44, var28, this.jq, var46, var47, var45, var40, var48, var43 + var39);
               }
            }
   ...
   public final void a(com.rsc.a.b.c var1, int var2, int var3) {
      ...
      int var4 = var3 * this.iU + var2;
      int var5 = 0;
      int var6 = var1.cn.bs;
      int var7 = var1.cn.br;
      int var8 = this.iU - var7;
      int var9 = 0;
      int var10;
      if (this.jr > var3) {
         var10 = this.jr - var3;
      ...
      if (var2 + var7 >= this.jt) {
         var10 = var2 + var7 - this.jt + 1;
         var7 -= var10;
         var9 += var10;
         var8 += var10;
      }
      ...
      if (var7 > 0 && var6 > 0) {
         ...
         this.a(var7, this.jq, var11, var6, var5, var4, var1.bb(), var8, var9);
      }
   ...
   public void a(com.rsc.a.a.g var1, int var2, int var3, int var4, int var5, int var6) {
      for(int var7 = 0; var7 < 12; ++var7) {
         int var8 = this.a.dD()[0][var7];
         int var9 = var1.t(var8);
         com.rsc.a.a.a var10 = com.rsc.a.a.m(var9);
         if (var10 != null && var9 >= 0) {
            com.rsc.a.b.c var11 = this.a.dC().c(var10.ad(), var6);
   ...
   public final void b(com.rsc.a.b.c var1, int var2, int var3, int var4, int var5) {
      try {
         ...
         if (var1.ci) {
            ...
            if (var1.ck * var5 % var13 != 0) {
               var9 = (var13 - var5 * var1.ck % var13 << 16) / var5;
            }

            var10 = (var12 << 16) / var4;
            if (var1.cj * var4 % var12 != 0) {
               var8 = (var12 - var1.cj * var4 % var12 << 16) / var4;
            }

            var2 += (var4 * var1.cj + var12 - 1) / var12;
            var11 = (var13 << 16) / var5;
            var3 += (var13 + var5 * var1.ck - 1) / var13;
            var5 = (var1.cn.bs - (var9 >> 16)) * var5 / var13;
            var4 = var4 * (var1.cn.br - (var8 >> 16)) / var12;
         }

         var12 = var2 + this.iU * var3;
         int var14;
         if (var3 < this.jr) {
            var14 = this.jr - var3;
            var9 += var11 * var14;
         ...
         var13 = this.iU - var4;
         if (var3 + var5 >= this.ju) {
            var5 -= var3 - this.ju + var5 + 1;
         }
         ...
         this.a(var1.bb(), var8, var9, var6, this.jq, var12, var4, var5, var13, var16, var10, var11);
      } catch (Exception var15) {
         System.out.println("error in sprite clipping routine");
      }
   ...
   public final void by() {
      int var1 = this.jp * this.iU;

      for(int var2 = 0; var1 > var2; ++var2) {
         int var3 = 16777215 & this.jq[var2];
         this.jq[var2] = (var3 >>> 1 & 8355711) + (var3 >>> 2 & 4144959) + (var3 >>> 3 & 2039583) + (var3 >>> 4 & 986895);
      }

   }

   public int ac(int var1) {
      return var1 < this.jB.length ? this.jB[var1] : this.ab(var1);
   }
   ...
   public final void n(int var1, int var2, int var3) {
      if (this.js <= var1 && this.jr <= var2 && this.jt > var1 && this.ju > var2) {
         this.jq[var1 + this.iU * var2] = var3;
      }
   ...
   public final void a(com.rsc.a.b.c var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, boolean var10, int var11, int var12) {
      try {
         ...
         int var13 = var1.cn.br;
         int var14 = var1.cn.bs;
         int var15 = 0;
         int var16 = 0;
         int var17 = var11 << 16;
         ...
         if (var1.ci) {
            ...
            var4 = (var18 + ((var1.cn.br << 16) - (var15 + 1))) / var18;
            var5 = ((var1.cn.bs << 16) - var16 - (1 - var19)) / var19;
         }
         ...
         if (var3 + var5 >= this.ju) {
            var5 -= 1 + var3 + var5 - this.ju;
         }

         var22 = var21 / this.iU & var12;
         if (!this.jb) {
            var22 = 2;
         }
         ...
         if (var7 == 16777215 && var8 == 16777215 && var9 == 255) {
            if (null != var1.cn) {
               if (var10) {
                  this.a(var1.bb(), var16, (var1.cn.br << 16) - (var15 + 1), var13, this.jq, var4, var5, var20, var21, var17, -var18, var19, var22, var6);
               } else {
                  this.a(var1.bb(), var16, var15, var13, this.jq, var4, var5, var20, var21, var17, var18, var19, var22, var6);
               }
            }
         } else if (var10) {
            this.a(this.jq, var1.bb(), var4, var20, var17, var7, var19, -var18, (var1.cn.br << 16) - var15 - 1, var22, var16, var13, var6, var5, var21, var8, var9);
         } else {
            this.a(this.jq, var1.bb(), var4, var20, var17, var7, var19, var18, var15, var22, var16, var13, var6, var5, var21, var8, var9);
         }
      } catch (Exception var26) {
   ...
   public final int c(int var1, String var2) {
      ...
      for(int var5 = 0; var5 < var2.length(); ++var5) {
         if (var2.charAt(var5) == '@' && 4 + var5 < var2.length() && var2.charAt(var5 + 4) == '@') {
            ...
            if (var6 < 0 || var6 >= com.rsc.c.a.dr.length) {
               var6 = ' ';
            }

            var3 += var4[com.rsc.c.a.dr[var6] + 7];
         }
      }
   ...
   private final void a(int[] var1, int var2, int var3, int var4, int[] var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, int var14) {
      ...
      try {
         ...
         for(int var19 = -var7; var19 < 0; ++var19) {
            ...
            var13 = 1 - var13;
            if (var21 + var22 >= this.jt) {
               var23 = var22 + var21 - this.jt;
               var22 -= var23;
            }
