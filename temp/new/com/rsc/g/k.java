...
public final class k {
   ...
   public static final String a(com.rsc.f.a var0) {
      ...
      try {
         ...
         var0.rV += a(var0.rU, var3, 0, var0.rV, -1, var2);
   ...
   public static final int a(com.rsc.f.a var0, String var1) {
      ...
      byte[] var3 = u(var1);
      var0.aM(var3.length);
      var0.rV += a(var3.length, var0.rU, var0.rV, var3);
      return var0.rV - var2;
   }
      ...
      for(int var4 = 0; var1 > var4; ++var4) {
         ...
         if (var5 != 0) {
            ...
            for(var10 = 0; var5 > var10; ++var10) {
               ...
               if (tM.length <= var9) {
                  int[] var12 = new int[tM.length * 2];

                  for(int var13 = 0; var13 < tM.length; ++var13) {
                     var12[var13] = tM[var13];
                  }
